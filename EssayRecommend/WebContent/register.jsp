					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<p class="text-center text-muted">
								已有账号,直接<a href="signin.jsp">登录</a>
							</p>
							<hr>

							<form id="regForm" method="post" action="RegisterAction">
								<div class="top-margin">
									<label>用户名 <span class="text-danger" id="span1">*</span></label>
									<input type="text" id="username" name="username"
										class="form-control">
								</div>
								<div class="top-margin">
									<label>邮箱地址 <span class="text-danger" id="span2">*</span></label> <input
										type="email" id="email" name="email" class="form-control">
								</div>

								<div class="top-margin">
									<label>密码 <span class="text-danger" id="span3">*</span></label> <input
										type="password" id="password" name="password" class="form-control">
								</div>
								<div class="top-margin">
									<label>确认密码 <span class="text-danger" id="span4">*</span></label> <input
										type="password" id="repassword" name="repassword" class="form-control">
								</div>
								<hr>
								<div class="row top-margin">
									<div class="col-lg-8">
										<label> &nbsp;&nbsp; 
										<input name="treaty" type="checkbox"> 我已经阅读过<a href="page_terms.html">注册条款</a>
										</label>
									</div>
									<div class="col-lg-4 text-right">
										<button class="btn btn-action" id="userAdd" type="button">注册</button>
									</div>
								</div>
							</form>
						</div>
